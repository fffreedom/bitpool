...
wget https://codeload.github.com/nmathewson/Libevent/tar.gz/release-2.1.8-stable -O Libevent-release-2.1.8-stable.tar.gz
#tar zxvf libevent-2.0.22-stable.tar.gz
tar zxvf Libevent-release-2.1.8-stable.tar.gz
